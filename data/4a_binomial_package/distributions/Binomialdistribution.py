...
class Binomial(Distribution):
    ...
    def plot_bar(self):
        ...
        plt.bar(x_values, y_values, color=['blue', 'orange'], alpha=0.7)
    ...
    def pdf(self, k):
        ...
        probability = binomial_coeff * ((self.p ** k) * (1 - self.p) ** (self.n - k))
        return probability
    ...
    def plot_bar_pdf(self):
        ...
        plt.bar(x_values, y_values, color='skyblue', alpha=0.7, edgecolor='black')

        plt.title("Probability Density Function (PDF) of Binomial Distribution")
    ...
    def __add__(self, other):
        ...
        #   new binomial object.
        result = Binomial(prob=new_p, size=new_n)
